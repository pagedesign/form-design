...
var dropSpec = {
  canDrop: function canDrop(props, monitor) {
    ...
    var targetFieldId = props.item.fieldId; //currentFieldId;

    var pids = designer.getPids(targetFieldId); // console.log(targetFieldId, 'pids: ', pids);
    //解决父节点拖动到子节点的情况
  ...
  hover: function hover(props, monitor, component) {
    ...
    if (!isOver) return; // console.log('item hover...')
